	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_q1lzo0z_caption)#",
					"color": "warn",
					"disabled": false,
					"size": "medium",
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.LookupAttribute_691vgxl;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.LookupAttribute_qeohmz9;
					var offerTypeId = "";
					if (offerTypeObject) {
